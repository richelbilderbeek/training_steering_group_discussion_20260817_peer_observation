...
<!--
  ...
  The other is [writing reflections](https://richelbilderbeek.github.io/teaching/teaching_overview/).
...
<details>
  ...
  Event                             |Goal
  ----------------------------------|---------------------------------------------
  Meeting before observing a session|Clarify expectations
  The observation takes place       |Have different perspectives on the same event
  You meet after observing a session|Discuss ideas

</details>

<details>
  <summary>What is recommended for a peer observation?</summary>
